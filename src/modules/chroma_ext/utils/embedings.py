...
class MyEmbeddingFunction(EmbeddingFunction):
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            text_type: "doc" for indexing, "query" for search queries.
        """
        ...
        self.logger.info(f"folder_id: {self.folder_id[:4]}***{self.folder_id[-4:]}")
    ...
    def _get_single_embedding(self, text: str) -> np.ndarray:
        """Get embedding for a single text with retries and exponential backoff."""
