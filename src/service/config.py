...
class AppSettings(BaseAppSettings):
    ...
    name: str = Field(validation_alias="PROJECT_NAME", default="RagChatBot")
...
class LogSettings(BaseAppSettings):
    ...
    audit_host_uid: str = Field(validation_alias="HOST_UID", default="00000000-0000-0000-0000-000000000000")
...
class YandexGPTSettings(BaseAppSettings):
    """YandexGPT Foundation Models settings."""
...
class LangFuseSettings(BaseAppSettings):
    """Langfuse tracing and prompt management settings."""
...
class ChromaSettings(BaseAppSettings):
    ...
    port: int = Field(validation_alias="CHROMA_PORT", default=8000)
    ...
    collection_name: str = Field(validation_alias="COLLECTION_NAME", default="PRODUCTION_COLLECTION")
    ...
    def header(self):
        return {
            ...
            "x-folder-id": self.openai_folder_id,
        }

    @property
    def doc_model_uri(self):
        return f"emb://{self.openai_folder_id}/text-search-doc/latest"

    @property
    def query_model_uri(self):
        return f"emb://{self.openai_folder_id}/text-search-query/latest"
...
class PostgreSettings(BaseAppSettings):
    ...
    postgres_db: str = Field(validation_alias="POSTGRES_DB", default="rag_chatbot_db")
    schema: str = Field(validation_alias="PG_SCHEMA", default="public")
...
class RedisSettings(BaseAppSettings):
    """Redis semantic cache and rate limiter settings."""
